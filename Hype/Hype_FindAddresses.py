...
# Scan for function that draws the main HUD (first call is to function that draws HUD borders)
regExp = re.compile(rb"""\xe8.{4}                       # call   ...
                         \xa0.{4}                       # mov    al,ds:...
                         \x84\xc0                       # test   al,al
                         \x74\x05                       # je     0x13
                         \xe8.{4}                       # call   ...
                         ...
                         \xe8.{4}                       # call   ...
""", re.VERBOSE | re.DOTALL)
scan_bytes(text_section_data, regExp, "addressDrawHUD", text_section_base_address)